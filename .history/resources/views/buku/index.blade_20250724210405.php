                            ...
                            <div class="flex items-center rounded-md bg-gray-100 dark:bg-gray-700 p-1">
                                <button @click="layout = 'grid'"
                                    :class="layout === 'grid' ? 'bg-white dark:bg-gray-900 text-indigo-600' :
                                        'text-gray-500'"
                                    class="p-1.5 rounded-md transition-colors duration-200" aria-label="Grid View">
                                ...
                                <button @click="layout = 'list'"
                                    :class="layout === 'list' ? 'bg-white dark:bg-gray-900 text-indigo-600' :
                                        'text-gray-500'"
                                    class="p-1.5 rounded-md transition-colors duration-200" aria-label="List View">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path fill-rule="evenodd"
                    ...
                    <div x-show="layout === 'grid'" x-transition
                        ...
                        @forelse ($buku as $item)
                            <div class="relative flex flex-col">
                                <div
                                    class="group aspect-h-3 aspect-w-2 w-full overflow-hidden rounded-lg bg-gray-200 dark:bg-gray-700">
                                    @if ($item->sampul)
