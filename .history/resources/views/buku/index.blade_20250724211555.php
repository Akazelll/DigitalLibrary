                    ...
                    <div x-show="layout === 'grid'" x-transition class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-6 gap-y-8">
                        @forelse ($buku as $item)
                            <div class="relative flex flex-col">
                                <div class="group aspect-h-3 aspect-w-2 w-full overflow-hidden rounded-lg bg-gray-200 dark:bg-gray-700 hover:shadow-lg transition-shadow">
                                    @if($item->sampul)
                                ...
                                @forelse ($buku as $item)
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm">
                                            ...
                                            @else
                                                <div class="h-16 w-12 rounded bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-400"><svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" /></svg></div>
                                            @endif
                                        </td>
