        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if (request('kategori'))
    <div class="mb-4 p-4 bg-indigo-50 dark:bg-indigo-900/50 rounded-lg flex items-center justify-between">
        <p class="text-sm text-indigo-800 dark:text-indigo-200">
            Menampilkan buku untuk kategori: <span class="font-bold">{{ request('kategori') }}</span>
        </p>
        <a href="{{ route('buku.index') }}" class="text-sm font-semibold text-indigo-600 hover:text-indigo-800">&times; Hapus Filter</a>
    </div>
@endif
