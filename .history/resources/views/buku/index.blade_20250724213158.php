                ...
                <div class="p-6 text-gray-900 dark:text-gray-100" x-data="{ layout: $persist('grid') }">
                        ...
                        @forelse ($buku as $item)
                            <div class="relative flex flex-col">
                                ...
                                <div class="mt-4 flex flex-col flex-1">
                                    {{-- PERUBAHAN DI SINI: Hapus kelas 'truncate' --}}
                                    <h3 class="text-sm font-medium text-gray-900 dark:text-white">{{ $item->judul_buku }}</h3>
                    ...
                    <div x-show="layout === 'list'" x-transition class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
                           {{-- ... (Isi tabel lengkap seperti jawaban sebelumnya) ... --}}
                        </table>
                    </div>
