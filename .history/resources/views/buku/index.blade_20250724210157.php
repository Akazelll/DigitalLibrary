    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                {{-- ======================================================================= --}}
                {{-- === PERUBAHAN 1: Tambahkan $persist untuk mengingat pilihan layout === --}}
                {{-- ======================================================================= --}}
                        ...
                        <div class="mt-4 sm:mt-0 flex items-center gap-4">
                            ...
                            <div class="flex items-center rounded-md bg-gray-100 dark:bg-gray-700 p-1">
                                ...
                                <button @click="layout = 'list'" :class="layout === 'list' ? 'bg-white dark:bg-gray-900 text-indigo-600' : 'text-gray-500'" class="p-1.5 rounded-md transition-colors duration-200" aria-label="Tampilan Daftar">
                                    <svg class="w-5 h-5" xmlns="http://www.w.3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10zm0 5.25a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75a.75.75 0 01-.75-.75z" clip-rule="evenodd" /></svg>
                                </button>
                            </div>
                            ...
                            <div class="relative flex flex-col">
                                ...
                                <div class="mt-4 flex flex-col flex-1">
                                    ...
                                    <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 flex items-center gap-2">
                                        <a href="{{ route('buku.edit', $item) }}" class="flex-1 text-center rounded-md bg-white dark:bg-gray-700 px-2.5 py-1.5 text-sm font-semibold text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 hover:bg-gray-50">Edit</a>
