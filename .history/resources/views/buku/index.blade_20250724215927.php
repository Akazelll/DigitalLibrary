                                    ...
                                    @if (Auth::user()->role == 'admin')
                                        <div
                                            ...
                                            <a href="{{ route('buku.edit', $item) }}"
                                                class="flex-1 text-center rounded-md bg-white dark:bg-green-700 px-2.5 py-1.5 text-sm font-semibold text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600">Edit</a>
