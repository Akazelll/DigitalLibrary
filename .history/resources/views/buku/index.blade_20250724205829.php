Tentu. Mari kita lengkapi fitur *switcher* dengan mengembalikan tampilan tabel yang sudah kita buat sebelumnya. Kita
juga akan membuatnya sedikit lebih baik dengan menambahkan kolom baru untuk *thumbnail* gambar sampul agar konsisten
dengan tampilan petak.

Kode di bawah ini adalah versi **final dan lengkap** untuk halaman `buku/index.blade.php`. Kode ini sudah berisi kedua
mode tampilan (petak dan daftar) yang bisa diganti secara interaktif menggunakan tombol *switcher*.
