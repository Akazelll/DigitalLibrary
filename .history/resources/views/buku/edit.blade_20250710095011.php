            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('buku.update', $buku->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <x-input-label class="block text-sm font-medium" for="stok" value="Stok Buku" />
                            <x-text-input id="stok" name="stok" type="number" class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm"
