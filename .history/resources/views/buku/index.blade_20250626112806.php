                                ...
                                <tr>
                                    ...
                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                        ...
                                        <form action="{{ route('buku.destroy', $item->id) }}" method="POST" id="delete-form-buku-{{ $item->id }}">
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" onclick="showAlert({{ $item->id }})" class="ml-4 text-red-600 dark:text-red-400 hover:text-red-900">Hapus</button>
                                        </form>
                                        {{-- ======================================================= --}}
                                    </td>
                                </tr>
...
{{-- ================= PERUBAHAN DI SINI (TAMBAHKAN SCRIPT) ================= --}}
<script>
    ...
    function showAlert(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Kirim form untuk menghapus data buku
                document.getElementById('delete-form-buku-' + id).submit();
            }
        })
    }
</script>
