                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="sm:flex sm:items-center mb-6">
                        <div class="sm:flex-auto">
                            <p class="text-sm text-gray-700 dark:text-gray-300">Daftar semua buku yang tersedia di
                                perpustakaan.</p>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-3 py-4 text-sm text-center">Data belum tersedia.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
    ...
    <script>
        ...
        function showAlert(id) {
            ...
            Swal.fire({
                ...
                background: isDarkMode ? '#1f2937' : '#fff', // gray-800 untuk dark, white untuk light
                color: isDarkMode ? '#d1d5db' : '#111827', // gray-300 untuk dark, gray-900 untuk light
                ...
                if (result.isConfirmed) {
                    ...
                    const form = document.getElementById('delete-form-' + id) || document.getElementById(
                        'delete-form-buku-' + id);
                    if (form) {
                        form.submit();
                    }
