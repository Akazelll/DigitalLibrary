<x-app-layout>
                        ...
                        <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    {{-- ================= PERUBAHAN 1: TAMBAHKAN HEADER STOK ================= --}}
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-800 bg-white dark:bg-gray-900">
                                @forelse ($buku as $item)
                                    <tr>
                                        ...
                                        {{-- ================= PERUBAHAN 2: TAMPILKAN DATA STOK ================= --}}
    ...
    @push('scripts')
        <style type="text/tailwindcss">
            .swal2-popup { @apply !rounded-lg !bg-white dark:!bg-gray-800; }
            .swal2-title { @apply !text-gray-900 dark:!text-gray-200; }
            .swal2-html-container { @apply !text-gray-600 dark:!text-gray-400; }
        </style>
        <script>
