                                        ...
                                        <div
                                            ...
                                            <form action="{{ route('buku.destroy', $item->id) }}" method="POST"
                                                ...
                                                <button type="button" onclick="showAlert({{ $item->id }}, 'buku')"
                                                    class="flex-1 text-center rounded-md bg-white dark:bg-gray-700 px-2.5 py-1.5 text-sm font-semibold text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-red-600 hover:bg-gray-50 dark:hover:bg-green-600">Hapus</button>
                                            </form>
                                        </div>
                                    @endif
                                </div>
