                        ...
                        <div class="mt-4 sm:mt-0 flex items-center gap-4">
                            ...
                            <div class="flex items-center rounded-md bg-gray-100 dark:bg-gray-700 p-1">
                                ...
                                <button @click="layout = 'list'"
                                    ...
                                    <svg class="w-5 h-5" xmlns="http://www.w.3.org/2000/svg" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path fill-rule="evenodd"
                    ...
                    <div x-show="layout === 'grid'" x-transition
                        ...
                        @forelse ($buku as $item)
                            <div class="relative flex flex-col">
                                <div
                                    class="group aspect-h-3 aspect-w-2 w-full overflow-hidden rounded-lg bg-gray-200 dark:bg-gray-700 hover:shadow-lg transition-shadow">
                                    @if ($item->sampul)
                                ...
                                <div class="mt-4 flex flex-col flex-1">
                                    ...
                                    <p class="mt-1 text-sm font-medium text-gray-900 dark:text-white">Stok:
                                        {{ $item->stok }}</p>
                                    ...
                                    @if (Auth::user()->role == 'admin')
                                        <div
                                            class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 flex items-center gap-2">
                                            <a href="{{ route('buku.edit', $item) }}"
                                                class="flex-1 text-center rounded-md bg-white dark:bg-gray-700 px-2.5 py-1.5 text-sm font-semibold text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 hover:bg-gray-50">Edit</a>
