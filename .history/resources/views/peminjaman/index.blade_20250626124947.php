<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Pilih rentang tanggal untuk mencetak
                        laporan dalam format PDF.</p>
    ...
    <script>
        // Fungsi untuk menampilkan SweetAlert2 untuk pengembalian
        function showReturnAlert(url) {
            Swal.fire({
                ...
                // Jika pengguna menekan tombol "Ya, sudah!"
                if (result.isConfirmed) {
                    // Arahkan ke URL pengembalian
