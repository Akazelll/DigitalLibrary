<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div x-data="{ open: false }" class="p-4 bg-yellow-200 text-yellow-800 rounded-md shadow-lg">
                <button @click="open = ! open" class="px-4 py-2 bg-yellow-500 text-white rounded font-bold">
                    Klik Tombol Tes Alpine.js Ini
                </button>
                <p x-show="open" class="mt-2 font-semibold">
                    Jika Anda bisa melihat teks ini setelah mengklik tombol, berarti Alpine.js BERFUNGSI.
                </p>
            </div>
        </div>
    </div>
