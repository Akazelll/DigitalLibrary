        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (Auth::user()->role == 'admin')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    {{-- Card Total Buku --}}
                    <a href="{{ route('buku.index') }}" class="group block p-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                        ...
                                        <li>
                                            <div class="relative pb-8">
                                                ...
                                                <div class="relative flex items-center space-x-3">
                                                    <div>
                                                        <span class="h-10 w-10 rounded-full bg-gray-400 dark:bg-gray-600 flex items-center justify-center ring-8 ring-white dark:ring-gray-800">
                                                            <svg class="h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 16a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" /></svg>
                                                        </span>
                                                    </div>
                                                    <div class="min-w-0 flex-1">
                                                        <p class="text-sm text-gray-500">
                                                            <span class="font-medium text-gray-900 dark:text-white">{{ $peminjaman->user->name }}</span>
                                                            meminjam buku <span class="font-medium text-gray-900 dark:text-white">{{ $peminjaman->buku?->judul_buku ?? '[Buku Telah Dihapus]' }}</span>
                                                        </p>
                                                        <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">{{ $peminjaman->created_at->diffForHumans() }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                    @empty
                                        <li><p class="text-sm text-gray-500">Belum ada aktivitas peminjaman.</p></li>
                                    @endforelse
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-1 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-base font-semibold leading-6 text-gray-900 dark:text-gray-100">Statistik Penambahan Buku</h3>
                             ...
                             <div class="p-6">
                                ...
                                <div class="mt-4 space-y-4">
                                    @forelse ($peminjamanUser as $peminjaman)
                                        <div class="border-l-4 @if($peminjaman->is_overdue) border-red-400 @elseif($peminjaman->status == 'pinjam') border-yellow-400 @else border-green-400 @endif pl-4 py-1">
