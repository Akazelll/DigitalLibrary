<x-app-layout>
    ...
    @forelse ($penerbit as $item)
        <tr>
            {{-- PERUBAHAN PADA PENOMORAN --}}
            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 dark:text-gray-200 sm:pl-6">{{ $penerbit->firstItem() + $loop->index }}</td>
