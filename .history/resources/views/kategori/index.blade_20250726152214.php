        ...
        <script>
            function showReturnAlert(url) {
                Swal.fire({
                    ...
                    // =======================================================
                    // === PERUBAHAN DI SINI: Menerapkan gaya Tailwind CSS ===
                    // =======================================================
                    customClass: {
                        popup: 'swal2-popup',
                        title: 'swal2-title',
                        htmlContainer: 'swal2-html-container',
                        confirmButton: 'rounded-md bg-green-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500', // Tombol konfirmasi hijau
                        cancelButton: 'ml-3 rounded-md bg-gray-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500'
                    },
                    buttonsStyling: false // Menonaktifkan gaya default
