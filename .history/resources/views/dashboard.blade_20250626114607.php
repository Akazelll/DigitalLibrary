        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Berikut adalah ringkasan data dari aplikasi perpustakaan Anda.</p>
                </div>
            </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total Buku</dt>
                                    <dd><div class="text-3xl font-semibold text-gray-900 dark:text-gray-200">{{ $totalBuku }}</div></dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('penerbit.index') }}" class="block bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total Penerbit</dt>
                                    <dd><div class="text-3xl font-semibold text-gray-900 dark:text-gray-200">{{ $totalPenerbit }}</div></dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 bg-yellow-500 rounded-md p-3">
                                <svg class="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h12M3.75 3.75h16.5M3.75 12h16.5m-16.5 4.5h16.5" /></svg>
                            </div>
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Peminjaman Aktif</dt>
                                    <dd><div class="text-3xl font-semibold text-gray-900 dark:text-gray-200">{{ $peminjamanAktif }}</div></dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0">
                                                    ...
                                                    <span class="inline-flex h-10 w-10 items-center justify-center rounded-full bg-gray-500">
                                                        <span class="font-medium leading-none text-white">{{ strtoupper(substr($peminjaman->user->name, 0, 2)) }}</span>
                                                    </span>
                                                </div>
                                                <div class="ml-4">
                                                    <div class="font-medium text-gray-900 dark:text-white">{{ $peminjaman->user->name }}</div>
                                                    <div class="text-gray-500">meminjam <span class="font-semibold">{{ $peminjaman->buku->judul_buku }}</span></div>
                                                </div>
                                            </div>
                                        </td>
