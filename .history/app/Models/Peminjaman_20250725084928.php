...
class Peminjaman extends Model
{
    ...
    protected function isOverdue(): Attribute
    {
        return Attribute::make(
            get: function () {
                // PERBAIKAN: Pertama, periksa apakah tanggal_harus_kembali ada isinya.
                // Jika tidak ada, atau statusnya bukan 'pinjam', maka tidak mungkin terlambat.
                if (!$this->tanggal_harus_kembali || $this->status !== 'pinjam') {
                    return false;
                }

                // Jika ada, baru lakukan perbandingan tanggal.
