...
{
    // 1. Ambil semua data penerbit dan simpan ke variabel $penerbit.
    $penerbit = \App\Models\Penerbit::all();

    // 2. Kirim variabel $penerbit ke view menggunakan compact().
    ...
    {
        return view('penerbit.create'); [cite: 79]
    }
    ...
    public function store(Request $request)
    {
        ...
        $penerbit->save(); [cite: 83]

        return redirect()->route('penerbit.index')->with('success', 'Data berhasil disimpan'); [cite: 83]
    }
