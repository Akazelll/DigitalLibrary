...
class PeminjamanController extends Controller
{
    ...
    {
        $peminjaman = \App\Models\Peminjaman::with(['user', 'buku'])->orderBy('tgl_pinjam', 'desc')->get();

        $data['peminjaman'] = \App\Models\Peminjaman::with(['user', 'buku'])
            ->latest('tgl_pinjam') // lebih singkat dari orderBy desc
            ->paginate(10);
