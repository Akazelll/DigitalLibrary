...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/tes-rute-buku', function () {
        return '<h1>HALAMAN TES INI BERHASIL DIMUAT</h1>';
    });
    ...
    // PERBAIKAN: Rute untuk melihat daftar kategori bisa diakses semua user
    ...
    Route::middleware('is.admin')->group(function () {
        ...
        // PERBAIKAN: Rute CRUD Kategori (selain index) hanya untuk admin
        Route::resource('kategori', KategoriController::class)->except(['index', 'show']);

        // Rute CRUD untuk Buku yang khusus Admin
        Route::get('/buku/create', [BukuController::class, 'create'])->name('buku.tambah-baru');
