<nav x-data="{ open: false }" class="bg-surface border-b border-gray-200 sticky top-0 z-50 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        ...
                        <span
                            class="font-semibold text-xl text-text-main">{{ config('app.name', 'DigiPustaka') }}</span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-text-subtle bg-surface hover:text-text-main focus:outline-none transition ease-in-out duration-150">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-text-subtle hover:text-text-main hover:bg-highlight focus:outline-none focus:bg-highlight focus:text-text-main transition duration-150 ease-in-out">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-text-subtle">{{ Auth::user()->email }}</div>
            </div>
