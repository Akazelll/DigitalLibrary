                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('buku.update', $buku->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" name="judul_buku" id="judul_buku" class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm" value="{{ old('judul_buku', $buku->judul_buku) }}">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <select id="id_penerbit" name="id_penerbit" class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="number" name="tahun_terbit" id="tahun_terbit" placeholder="YYYY" class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm" value="{{ old('tahun_terbit', $buku->tahun_terbit) }}">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="number" name="jml_halaman" id="jml_halaman" class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm" value="{{ old('jml_halaman', $buku->jml_halaman) }}">
                            </div>
